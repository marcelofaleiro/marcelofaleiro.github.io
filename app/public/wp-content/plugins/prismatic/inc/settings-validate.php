...
function prismatic_validate_advanced($input) {
	
	if (isset($input['custom_style'])) $input['custom_style'] = trim(stripslashes(wp_filter_nohtml_kses($input['custom_style'])));
	else $input['custom_style'] = null;
